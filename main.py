...
class Reporter:
    ...
    def update_title(self):
        ctypes.windll.kernel32.SetConsoleTitleW("Discord report spammer by vqea | Sent: {0} | Errors: {1}".format(self.reported, self.errors))
...
ctypes.windll.kernel32.SetConsoleTitleW("Discord peport spammer by vqea")
